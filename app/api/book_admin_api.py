...
class BookAdminAPI:
    ...
    def __init__(self):
        ...
        # Route registration     
        self.router.add_api_route("/add_book", self.add_book, methods=["POST"])
        self.router.add_api_route("/update_book/{book_id}", self.update_book, methods=["PUT"])
        self.router.add_api_route("/delete_book/{book_id}", self.delete_book, methods=["DELETE"])
    ...
    def update_book(self, book: Book, book_id: int):
        ...
        return self.book_admin_service.update_book(book, book_id)
    ...
    def get_all_books(self):
        logger.info("All books havr been fetched successfully.")
